...
Meteor.startup(() => {
  if (ProductsCollection.find().count() === 0) {
    ...
    const products = [
      ...
      {name: 'Fila Hypercube trainers in black and zebra', description:'Founded in 1911 by brothers in Biella, Italy.', old_price:3500, price:2300, stock:2, image_url:'https://images.asos-media.com/products/fila-hypercube-trainers-in-black-and-zebra-print-in-black/203666495-1-black?$n_640w$&wid=513&fit=constrain', userId: user._id},
      ...
      {name: 'Penfold ski suit in pink', description:'Old School Ski is here to rewrite your slope steez with outrageous 80s vibes.', old_price:2450, price:1900, stock:6,image_url:'https://images.asos-media.com/products/oosc-x-penfold-ski-suit-in-pink/203655584-1-pink?$n_640w$&wid=513&fit=constrain', userId: user._id},
      {name: 'Peoples Princess ski suit in black', description:'Retaining its fashion authority and the very best of its heritage', old_price:2030, price:1940, stock:6,image_url:'https://images.asos-media.com/products/oosc-peoples-princess-ski-suit-in-black/203655615-1-black?$n_640w$&wid=513&fit=constrain', userId: user._id},
      {name: 'Tighty ski suit in cream', description:'Not skimping on functionality,is waterproof and fully insulated.', old_price:4700, price:3580, stock:7,image_url:'https://images.asos-media.com/products/oosc-tighty-ski-suit-in-cream/203655656-3?$n_640w$&wid=513&fit=constrain', userId: user._id},
